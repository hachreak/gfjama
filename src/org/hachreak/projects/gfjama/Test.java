...
package org.hachreak.projects.gfjama;
...
public class Test {
  ...
  static private final Map<Integer, Test> instances =
    new HashMap<Integer, Test>();
   ...
   */
  public static Test getInstance(int fieldSize,
    ...
    synchronized (instances) {
      ...
      if (gf == null) {
        gf = new Test(fieldSize, primitivePolynomial);
  ...
  private Test(int fieldSize, int primitivePolynomial) {
    assert fieldSize > 0;
